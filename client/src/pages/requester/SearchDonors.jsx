    ...
    <div className="min-h-screen" style={{ backgroundColor: '#fdf6ec' }}>
      ...
      <div className="max-w-5xl mx-auto px-4 py-8">
        <div className="mb-6">
          ...
          <p className="text-gray-500 text-sm mt-1">Search for eligible blood donors near you</p>
        </div>
          ...
          <div>
            ...
            {donors.length === 0 ? (
              <div className="bg-white rounded-2xl shadow-sm p-12 text-center">
                ...
                <div className="text-sm text-gray-400 mt-1">Try increasing the search distance or changing blood group</div>
              </div>
            ) : (
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {donors.map(donor => (
                  <div key={donor._id} className="bg-white rounded-xl shadow-sm p-5 hover:shadow-md transition border-l-4" style={{ borderLeftColor: '#7f0000' }}>
                    ...
                    <button
                      onClick={() => window.location.href = `mailto:${donor.user_id?.email}`}
                      className="w-full text-white py-2 rounded-lg font-medium transition text-sm"
                      style={{ backgroundColor: '#7f0000' }}
                    >
                      Contact Donor
                    </button>
